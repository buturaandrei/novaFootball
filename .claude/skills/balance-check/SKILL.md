...
---
*Adattata da [Claude-Code-Game-Studios](https://github.com/Donchitos/Claude-Code-Game-Studios) (Donchitos, licenza MIT) — installata la sola skill, senza hook/agenti/settings.*
